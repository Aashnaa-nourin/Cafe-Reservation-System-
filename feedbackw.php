...
<body>
    <div class="sidebar">
        <a href="#menu"></a>
        <a href="waiterhome.html" id="hover-effect">Dashboard</a>
        <a href="waiterorder.html" id="hover-effect">ORDER DETAILS</a>
        <a href="waitertable.html" id="hover-effect">TABLE DETAILS</a>
    ...
    <div class="content">
        <div class="header">
            <h1>cAfeARo Waiter Dashboard-Feedback details</h1>
        </div>
       &nbsp;


       <div> <a href="waiterhome.html" class="hero_bt"><h3>back</h3></a>
